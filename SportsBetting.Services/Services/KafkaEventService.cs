...
namespace SportsBetting.Services.Services
{
    public class KafkaEventService : IKafkaEventService
    {
        ...
        public KafkaEventService(IEventRepository eventRepository, ITeamRepository teamRepository, ILeagueRepository leagueRepository, ISportRepository sportRepository)
        {
